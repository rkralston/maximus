      ...
      this.sub5 = this.weather.getForecast(this.city).subscribe((data: any) => {
        ...
        for (let index = 0; index < data.length; index++) {
          ...
          if (((date === todayNumberInWeek + 1) || (todayNumberInWeek === 6 && date === 0)) && !this.day1Name) {
            ...
            this.day2Temp = Math.round(date[index].main.temp);
          } else if (!!this.day2Name && !this.day3Name && days[date] !== this.day2Name) {
            this.day3Name = days[date];
            this.day3State = data[index].weather[0].main;
            this.day3Temp = Math.round(date[index].main.temp);
            ...
            this.day4Temp = Math.round(date[index].main.temp);
            ...
            this.day5Temp = Math.round(date[index].main.temp);
          }
        }
      });
    });
